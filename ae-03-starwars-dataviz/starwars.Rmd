...
- This allows you to see some of the variable values
...
# geom = geometry --> how the data is rendered
# see ggplot2.tidyverse.org/reference/index.html

ggplot(starwars, 
       aes(x = height, y = mass, color = gender, size = birth_year)) +
  geom_point(color = "#30509C") + 
  labs(
    title = "Mass vs. Height of Starwards Characters",
    x = "Height (cm)", 
    y = "Weight (kg)"
